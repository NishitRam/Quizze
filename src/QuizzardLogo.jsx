...
export default function QuizzardLogo({ size = 120, className = '' }) {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      <path d="M60 25 L45 55 L75 55 Z" fill="url(#hatGradient)" opacity="0.7"/>
      ...
      {/* Inner glow */}
      <circle cx="60" cy="75" r="12" fill="url(#innerGlow)" opacity="0.3"/>
      ...
      <circle cx="60" cy="100" r="1.5" fill="#FFD700" opacity="0.8"/>
      ...
      <defs>
        ...
        <linearGradient id="hatGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style={{stopColor:'#764ba2', stopOpacity:0.8}} />
          <stop offset="100%" style={{stopColor:'#667eea', stopOpacity:0.8}} />
        </linearGradient>
        <radialGradient id="innerGlow">
          <stop offset="0%" style={{stopColor:'#FFFFFF', stopOpacity:0.8}} />
          <stop offset="100%" style={{stopColor:'#667eea', stopOpacity:0.2}} />
        </radialGradient>
      </defs>
    </svg>
  );
